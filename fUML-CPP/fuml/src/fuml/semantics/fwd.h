...
using AcceptEventActionActivationPtr_w = std::weak_ptr<AcceptEventActionActivation>;
...
using ActionActivationPtr_w = std::weak_ptr<ActionActivation>;
...
using ConditionalNodeActivationPtr_w = std::weak_ptr<ConditionalNodeActivation>;
...
using ExpansionActivationGroupPtr_w = std::weak_ptr<ExpansionActivationGroup>;
...
using ExpansionRegionActivationPtr_w = std::weak_ptr<ExpansionRegionActivation>;
...
using LoopNodeActivationPtr_w = std::weak_ptr<LoopNodeActivation>;
...
using StructuredActivityNodeActivationPtr_w = std::weak_ptr<StructuredActivityNodeActivation>;
...
using ActivityExecutionPtr_w = std::weak_ptr<ActivityExecution>;
...
using ActivityNodeActivationPtr_w = std::weak_ptr<ActivityNodeActivation>;
...
using ActivityNodeActivationGroupPtr_w = std::weak_ptr<ActivityNodeActivationGroup>;
...
using ActivityParameterNodeActivationPtr_w = std::weak_ptr<ActivityParameterNodeActivation>;
...
using ForkedTokenPtr_w = std::weak_ptr<ForkedToken>;
...
using ObjectNodeActivationPtr_w = std::weak_ptr<ObjectNodeActivation>;
using ObjectToken = fuml::semantics::activities::ObjectToken;
using ObjectTokenPtr = std::shared_ptr<ObjectToken>;
using ObjectTokenPtr_w = std::weak_ptr<ObjectToken>;
...
using TokenPtr_w = std::weak_ptr<Token>;
...
using CallEventBehaviorPtr_w = std::weak_ptr<CallEventBehavior>;
...
using CallEventExecutionPtr_w = std::weak_ptr<CallEventExecution>;
...
using ClassifierBehaviorInvocationEventAccepterPtr_w = std::weak_ptr<ClassifierBehaviorInvocationEventAccepter>;
...
using EventOccurrencePtr_w = std::weak_ptr<EventOccurrence>;
...
using EventOccurrence_SendingBehaviorExecutionPtr_w = std::weak_ptr<EventOccurrence_SendingBehaviorExecution>;
...
using ObjectActivationPtr_w = std::weak_ptr<ObjectActivation>;
...
using ObjectActivation_EventDispatchLoopExecutionPtr_w = std::weak_ptr<ObjectActivation_EventDispatchLoopExecution>;
...
using LocusPtr_w = std::weak_ptr<Locus>;
...
using ExtensionalValuePtr_w = std::weak_ptr<ExtensionalValue>;
...
using LinkPtr_w = std::weak_ptr<Link>;
...
using Object_Ptr_w = std::weak_ptr<Object_>;
