/*
 * CS_AcceptEventActionActivation.cpp
 *
...
void CS_AcceptEventActionActivation::accept(const EventOccurrencePtr& eventOccurrence)
{
    ...
    {
        AcceptEventActionActivation::accept(cS_EventOccurrence->wrappedEventOccurrence);
    }
    else
    {
