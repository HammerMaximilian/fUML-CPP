...
bool SignalEventOccurrence::match(
...
ParameterValueListPtr SignalEventOccurrence::getParameterValues(
		const EventPtr& event)
{
	...
	if (signalEvent)
	{
		StructuralFeatureListPtr memberFeatures =
				this->signalInstance->getMemberFeatures(signalEvent->signal);
