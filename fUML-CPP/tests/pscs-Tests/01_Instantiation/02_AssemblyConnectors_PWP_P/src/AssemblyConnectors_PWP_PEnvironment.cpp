/*
 * AssemblyConnectors_PWP_PEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "AssemblyConnectors_PWP_PEnvironment.h"
...
AssemblyConnectors_PWP_PEnvironment::AssemblyConnectors_PWP_PEnvironment()
{
...
const std::shared_ptr<AssemblyConnectors_PWP_PEnvironment>& AssemblyConnectors_PWP_PEnvironment::Instance()
{
	static std::shared_ptr<AssemblyConnectors_PWP_PEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new AssemblyConnectors_PWP_PEnvironment());
...
void AssemblyConnectors_PWP_PEnvironment::execute(std::string behaviorName)
{
