/*
 * DelegationConnectors_P_PEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "DelegationConnectors_P_PEnvironment.h"
...
DelegationConnectors_P_PEnvironment::DelegationConnectors_P_PEnvironment()
{
...
const std::shared_ptr<DelegationConnectors_P_PEnvironment>& DelegationConnectors_P_PEnvironment::Instance()
{
	static std::shared_ptr<DelegationConnectors_P_PEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new DelegationConnectors_P_PEnvironment());
...
void DelegationConnectors_P_PEnvironment::execute(std::string behaviorName)
{
