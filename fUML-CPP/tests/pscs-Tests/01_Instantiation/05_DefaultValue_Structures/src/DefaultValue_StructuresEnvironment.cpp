/*
 * DefaultValue_StructuresEnvironment.cpp
 * 
 * Auto-generated file
 */
...
DefaultValue_StructuresEnvironment::DefaultValue_StructuresEnvironment()
{
...
const std::shared_ptr<DefaultValue_StructuresEnvironment>& DefaultValue_StructuresEnvironment::Instance()
{
	static std::shared_ptr<DefaultValue_StructuresEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new DefaultValue_StructuresEnvironment());
...
void DefaultValue_StructuresEnvironment::execute(std::string behaviorName)
{
