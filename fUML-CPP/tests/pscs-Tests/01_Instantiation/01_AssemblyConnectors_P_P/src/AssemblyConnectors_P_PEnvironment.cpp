/*
 * AssemblyConnectors_P_PEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "AssemblyConnectors_P_PEnvironment.h"
...
AssemblyConnectors_P_PEnvironment::AssemblyConnectors_P_PEnvironment()
{
...
const std::shared_ptr<AssemblyConnectors_P_PEnvironment>& AssemblyConnectors_P_PEnvironment::Instance()
{
	static std::shared_ptr<AssemblyConnectors_P_PEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new AssemblyConnectors_P_PEnvironment());
...
void AssemblyConnectors_P_PEnvironment::execute(std::string behaviorName)
{
