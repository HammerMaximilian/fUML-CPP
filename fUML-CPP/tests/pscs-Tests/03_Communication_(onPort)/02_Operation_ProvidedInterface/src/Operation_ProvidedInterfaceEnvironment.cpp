/*
 * Operation_ProvidedInterfaceEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "Operation_ProvidedInterfaceEnvironment.h"
...
Operation_ProvidedInterfaceEnvironment::Operation_ProvidedInterfaceEnvironment()
{
...
const std::shared_ptr<Operation_ProvidedInterfaceEnvironment>& Operation_ProvidedInterfaceEnvironment::Instance()
{
	static std::shared_ptr<Operation_ProvidedInterfaceEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new Operation_ProvidedInterfaceEnvironment());
...
void Operation_ProvidedInterfaceEnvironment::execute(std::string behaviorName)
{
