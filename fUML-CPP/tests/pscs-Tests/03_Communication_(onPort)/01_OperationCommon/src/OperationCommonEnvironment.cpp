/*
 * OperationCommonEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "OperationCommonEnvironment.h"
...
OperationCommonEnvironment::OperationCommonEnvironment()
{
...
const std::shared_ptr<OperationCommonEnvironment>& OperationCommonEnvironment::Instance()
{
	static std::shared_ptr<OperationCommonEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new OperationCommonEnvironment());
...
void OperationCommonEnvironment::execute(std::string behaviorName)
{
