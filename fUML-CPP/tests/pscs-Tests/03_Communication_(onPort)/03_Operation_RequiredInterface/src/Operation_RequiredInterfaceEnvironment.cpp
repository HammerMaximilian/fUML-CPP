/*
 * Operation_RequiredInterfaceEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "Operation_RequiredInterfaceEnvironment.h"
...
Operation_RequiredInterfaceEnvironment::Operation_RequiredInterfaceEnvironment()
{
...
const std::shared_ptr<Operation_RequiredInterfaceEnvironment>& Operation_RequiredInterfaceEnvironment::Instance()
{
	static std::shared_ptr<Operation_RequiredInterfaceEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new Operation_RequiredInterfaceEnvironment());
...
void Operation_RequiredInterfaceEnvironment::execute(std::string behaviorName)
{
