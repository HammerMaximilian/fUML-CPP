/*
 * Operation_ProvidedAndRequiredInterfaceEnvironment.cpp
 * 
 * Auto-generated file
 */
...
Operation_ProvidedAndRequiredInterfaceEnvironment::Operation_ProvidedAndRequiredInterfaceEnvironment()
{
...
const std::shared_ptr<Operation_ProvidedAndRequiredInterfaceEnvironment>& Operation_ProvidedAndRequiredInterfaceEnvironment::Instance()
{
	static std::shared_ptr<Operation_ProvidedAndRequiredInterfaceEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new Operation_ProvidedAndRequiredInterfaceEnvironment());
...
void Operation_ProvidedAndRequiredInterfaceEnvironment::execute(std::string behaviorName)
{
