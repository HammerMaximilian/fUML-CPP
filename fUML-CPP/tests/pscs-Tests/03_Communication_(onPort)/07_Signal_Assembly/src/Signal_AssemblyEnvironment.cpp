/*
 * Signal_AssemblyEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "Signal_AssemblyEnvironment.h"
...
Signal_AssemblyEnvironment::Signal_AssemblyEnvironment()
{
...
const std::shared_ptr<Signal_AssemblyEnvironment>& Signal_AssemblyEnvironment::Instance()
{
	static std::shared_ptr<Signal_AssemblyEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new Signal_AssemblyEnvironment());
...
void Signal_AssemblyEnvironment::execute(std::string behaviorName)
{
