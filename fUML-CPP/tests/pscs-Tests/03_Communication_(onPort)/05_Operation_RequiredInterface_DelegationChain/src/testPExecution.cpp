...
{
	this->types->push_back(Operation_RequiredInterface_DelegationChainModel::Instance()->Operation_RequiredInterface_DelegationChain_main_testP);
	...
	const ParameterValueListPtr& outputParameters)
{
	...
	std::cout<<"Invocation forwarded out of e through q: ";
