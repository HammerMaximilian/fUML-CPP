/*
 * SignalCommonEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "SignalCommonEnvironment.h"
...
SignalCommonEnvironment::SignalCommonEnvironment()
{
...
const std::shared_ptr<SignalCommonEnvironment>& SignalCommonEnvironment::Instance()
{
	static std::shared_ptr<SignalCommonEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new SignalCommonEnvironment());
...
void SignalCommonEnvironment::execute(std::string behaviorName)
{
