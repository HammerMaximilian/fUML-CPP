/*
 * MultipleDelegation_SameConnector_P_P_SignalEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "MultipleDelegation_SameConnector_P_P_SignalEnvironment.h"
...
MultipleDelegation_SameConnector_P_P_SignalEnvironment::MultipleDelegation_SameConnector_P_P_SignalEnvironment()
{
...
const std::shared_ptr<MultipleDelegation_SameConnector_P_P_SignalEnvironment>& MultipleDelegation_SameConnector_P_P_SignalEnvironment::Instance()
{
	static std::shared_ptr<MultipleDelegation_SameConnector_P_P_SignalEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new MultipleDelegation_SameConnector_P_P_SignalEnvironment());
...
void MultipleDelegation_SameConnector_P_P_SignalEnvironment::execute(std::string behaviorName)
{
