/*
 * SingleDelegation_P_P_OperationEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "SingleDelegation_P_P_OperationEnvironment.h"
...
SingleDelegation_P_P_OperationEnvironment::SingleDelegation_P_P_OperationEnvironment()
{
...
const std::shared_ptr<SingleDelegation_P_P_OperationEnvironment>& SingleDelegation_P_P_OperationEnvironment::Instance()
{
	static std::shared_ptr<SingleDelegation_P_P_OperationEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new SingleDelegation_P_P_OperationEnvironment());
...
void SingleDelegation_P_P_OperationEnvironment::execute(std::string behaviorName)
{
