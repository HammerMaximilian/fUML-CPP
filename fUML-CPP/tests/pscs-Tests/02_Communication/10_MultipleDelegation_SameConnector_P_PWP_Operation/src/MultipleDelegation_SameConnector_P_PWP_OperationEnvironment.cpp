/*
 * MultipleDelegation_SameConnector_P_PWP_OperationEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "MultipleDelegation_SameConnector_P_PWP_OperationEnvironment.h"
...
MultipleDelegation_SameConnector_P_PWP_OperationEnvironment::MultipleDelegation_SameConnector_P_PWP_OperationEnvironment()
{
...
const std::shared_ptr<MultipleDelegation_SameConnector_P_PWP_OperationEnvironment>& MultipleDelegation_SameConnector_P_PWP_OperationEnvironment::Instance()
{
	static std::shared_ptr<MultipleDelegation_SameConnector_P_PWP_OperationEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new MultipleDelegation_SameConnector_P_PWP_OperationEnvironment());
...
void MultipleDelegation_SameConnector_P_PWP_OperationEnvironment::execute(std::string behaviorName)
{
