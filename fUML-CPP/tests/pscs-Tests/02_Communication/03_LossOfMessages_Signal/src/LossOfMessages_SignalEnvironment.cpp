/*
 * LossOfMessages_SignalEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "LossOfMessages_SignalEnvironment.h"
...
LossOfMessages_SignalEnvironment::LossOfMessages_SignalEnvironment()
{
...
const std::shared_ptr<LossOfMessages_SignalEnvironment>& LossOfMessages_SignalEnvironment::Instance()
{
	static std::shared_ptr<LossOfMessages_SignalEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new LossOfMessages_SignalEnvironment());
...
void LossOfMessages_SignalEnvironment::execute(std::string behaviorName)
{
