/*
 * LossOfMessages_OperationEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "LossOfMessages_OperationEnvironment.h"
...
LossOfMessages_OperationEnvironment::LossOfMessages_OperationEnvironment()
{
...
const std::shared_ptr<LossOfMessages_OperationEnvironment>& LossOfMessages_OperationEnvironment::Instance()
{
	static std::shared_ptr<LossOfMessages_OperationEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new LossOfMessages_OperationEnvironment());
...
void LossOfMessages_OperationEnvironment::execute(std::string behaviorName)
{
