...
{
	this->types->push_back(MultipleDelegation_SameConnector_P_PWP_SignalModel::Instance()->MultipleDelegation_SameConnector_P_PWP_Signal_Tester_testActivity_testP);
	...
	const ParameterValueListPtr& outputParameters)
{
	...
	if(index == 1)
	{
		std::cout<<"Asserting c.a[1].b.p == 4 && c.a[2].b.p == 4 && c.a[3].b.p == 4 && c.a[4].b.p == 4"<<std::endl;
	}
