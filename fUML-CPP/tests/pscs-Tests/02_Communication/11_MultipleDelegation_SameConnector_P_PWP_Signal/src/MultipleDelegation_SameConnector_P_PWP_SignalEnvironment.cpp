/*
 * MultipleDelegation_SameConnector_P_PWP_SignalEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "MultipleDelegation_SameConnector_P_PWP_SignalEnvironment.h"
...
MultipleDelegation_SameConnector_P_PWP_SignalEnvironment::MultipleDelegation_SameConnector_P_PWP_SignalEnvironment()
{
...
const std::shared_ptr<MultipleDelegation_SameConnector_P_PWP_SignalEnvironment>& MultipleDelegation_SameConnector_P_PWP_SignalEnvironment::Instance()
{
	static std::shared_ptr<MultipleDelegation_SameConnector_P_PWP_SignalEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new MultipleDelegation_SameConnector_P_PWP_SignalEnvironment());
...
void MultipleDelegation_SameConnector_P_PWP_SignalEnvironment::execute(std::string behaviorName)
{
