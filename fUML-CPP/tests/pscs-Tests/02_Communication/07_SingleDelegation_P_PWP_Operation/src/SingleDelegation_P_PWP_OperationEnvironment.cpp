/*
 * SingleDelegation_P_PWP_OperationEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "SingleDelegation_P_PWP_OperationEnvironment.h"
...
SingleDelegation_P_PWP_OperationEnvironment::SingleDelegation_P_PWP_OperationEnvironment()
{
...
const std::shared_ptr<SingleDelegation_P_PWP_OperationEnvironment>& SingleDelegation_P_PWP_OperationEnvironment::Instance()
{
	static std::shared_ptr<SingleDelegation_P_PWP_OperationEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new SingleDelegation_P_PWP_OperationEnvironment());
...
void SingleDelegation_P_PWP_OperationEnvironment::execute(std::string behaviorName)
{
