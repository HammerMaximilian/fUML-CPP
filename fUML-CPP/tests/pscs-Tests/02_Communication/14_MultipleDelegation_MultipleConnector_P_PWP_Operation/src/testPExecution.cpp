...
{
	this->types->push_back(MultipleDelegation_MultipleConnector_P_PWP_OperationModel::Instance()->MultipleDelegation_MultipleConnector_P_PWP_Operation_main_testP);
	...
	const ParameterValueListPtr& outputParameters)
{
	...
	if(index == 1)
	{
		std::cout<<"Asserting c.a1.b.p == 4 || c.a2.b.p == 4 || c.a3.b.p == 4 || c.a4.b.c == 4"<<std::endl;
	}
