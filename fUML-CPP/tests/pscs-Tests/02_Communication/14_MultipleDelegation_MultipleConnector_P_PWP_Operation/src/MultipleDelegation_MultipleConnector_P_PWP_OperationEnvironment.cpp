/*
 * MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment.h"
...
MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment::MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment()
{
...
const std::shared_ptr<MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment>& MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment::Instance()
{
	static std::shared_ptr<MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment());
...
void MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment::execute(std::string behaviorName)
{
