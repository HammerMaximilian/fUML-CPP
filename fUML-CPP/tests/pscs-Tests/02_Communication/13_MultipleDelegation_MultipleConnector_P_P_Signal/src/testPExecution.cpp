...
{
	this->types->push_back(MultipleDelegation_MultipleConnector_P_P_SignalModel::Instance()->MultipleDelegation_MultipleConnector_P_P_Signal_Tester_testActivity_testP);
	...
	const ParameterValueListPtr& outputParameters)
{
	...
	if(index == 1)
	{
		std::cout<<"Asserting a.b1.p == 4 && a.b2.p == 4 && a.b3.p == 4 && a.b4.p == 4"<<std::endl;
	}
