/*
 * MultipleDelegation_MultipleConnector_P_P_OperationEnvironment.cpp
 * 
 * Auto-generated file
 */
...
MultipleDelegation_MultipleConnector_P_P_OperationEnvironment::MultipleDelegation_MultipleConnector_P_P_OperationEnvironment()
{
...
const std::shared_ptr<MultipleDelegation_MultipleConnector_P_P_OperationEnvironment>& MultipleDelegation_MultipleConnector_P_P_OperationEnvironment::Instance()
{
	static std::shared_ptr<MultipleDelegation_MultipleConnector_P_P_OperationEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new MultipleDelegation_MultipleConnector_P_P_OperationEnvironment());
...
void MultipleDelegation_MultipleConnector_P_P_OperationEnvironment::execute(std::string behaviorName)
{
