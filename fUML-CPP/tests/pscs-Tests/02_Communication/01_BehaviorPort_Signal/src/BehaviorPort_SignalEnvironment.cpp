/*
 * BehaviorPort_SignalEnvironment.cpp
 * 
 * Auto-generated file
 */

#include "BehaviorPort_SignalEnvironment.h"
...
BehaviorPort_SignalEnvironment::BehaviorPort_SignalEnvironment()
{
...
const std::shared_ptr<BehaviorPort_SignalEnvironment>& BehaviorPort_SignalEnvironment::Instance()
{
	static std::shared_ptr<BehaviorPort_SignalEnvironment> instance = nullptr;

	if(!instance)
	{
		instance.reset(new BehaviorPort_SignalEnvironment());
...
void BehaviorPort_SignalEnvironment::execute(std::string behaviorName)
{
